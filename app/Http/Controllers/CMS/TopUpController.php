...
class TopUpController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.cms.top-up.index')->with('success', 'Top Up Product created successfully.');
    }

    public function show(Banner $banner)
    {
        return view('dashboard.cms.top-up.show', compact('top-up'));
    }

    public function edit(Banner $banner)
    {
        return view('dashboard.cms.top-up.edit', compact('top-up'));
    }
